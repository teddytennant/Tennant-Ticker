...
export const PinContainer = ({
  ...
  useEffect(() => {
    console.log('PinContainer mounted', { title, href, external });
    
    return () => {
      console.log('PinContainer unmounted', { title });
    };
  }, [title, href, external]);
  ...
  if (external) {
    return (
      ...
      >
        ...
        <PinPerspective title={title} href={href} external={true} />
      </a>
    );
  }
  ...
  return (
    ...
    >
      ...
      <PinPerspective title={title} href={href} external={false} />
    </Link>
  );
};
